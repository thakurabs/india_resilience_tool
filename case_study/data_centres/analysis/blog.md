...
That is a 7.5-fold difference over a distance many infrastructure strategies would treat as one regional choice.

This is not an argument that Mumbai is “bad” and Pune is “good”. Nor is it a verdict on any individual campus. It is a block-level signal that should change the questions asked before a long-lived asset is financed, permitted or designed. Data centres depend on cooling headroom, reliable power, water or other heat-rejection capacity, drainage, access roads and resilient off-site infrastructure. Climate pressure on those systems can shift sharply even where the commercial geography appears continuous.
