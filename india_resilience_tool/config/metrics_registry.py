...
DASHBOARD_ONLY_METRICS_RAW: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "slug": "population_age_65plus_count",
        "label": "Population Aged 65+",
        "group": "other",
        "value_col": "population_age_65plus_count",
        "periods_metric_col": "population_age_65plus_count",
        "units": "people",
        "description": (
            "2025 population aged 65 and over, summed from WorldPop age-sex bands. WorldPop applies one State-level age proportion to every grid cell, so this carries no sub-state variation and must not drive a district or block map fill."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
        ...
        "supports_baseline_comparison": False,
        "supports_scenario_comparison": False,
        "admin_rebuild_command": "python -m tools.geodata.build_worldpop_agesex_admin_masters --overwrite",
        "supported_scenarios": ("snapshot",),
        "preferred_period_order": ("2025",),
        "supported_spatial_families": ("admin",),
        "supported_levels": ("district", "block"),
    ...
    {
        "name": "Population Aged 65+ Share",
        "slug": "population_age_65plus_share_pct",
        "label": "Population Aged 65+ Share",
        "group": "other",
        "value_col": "population_age_65plus_share_pct",
        "periods_metric_col": "population_age_65plus_share_pct",
        "units": "percent",
        "description": (
            "Percent of 2025 population aged 65 and over. WorldPop applies one State-level age proportion to every grid cell, so this carries no sub-state variation and must not drive a district or block map fill."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    },
    {
        ...
        "slug": "population_age_under5_count",
        "label": "Population Under 5",
        "group": "other",
        "value_col": "population_age_under5_count",
        "periods_metric_col": "population_age_under5_count",
        "units": "people",
        "description": (
            "2025 population under 5 years, summed from WorldPop age-sex bands. WorldPop applies one State-level age proportion to every grid cell, so this carries no sub-state variation and must not drive a district or block map fill."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    {
        "name": "Population Under 5 Share",
        "slug": "population_age_under5_share_pct",
        "label": "Population Under 5 Share",
        "group": "other",
        "value_col": "population_age_under5_share_pct",
        "periods_metric_col": "population_age_under5_share_pct",
        "units": "percent",
        "description": (
            "Percent of 2025 population under 5 years. WorldPop applies one State-level age proportion to every grid cell, so this carries no sub-state variation and must not drive a district or block map fill."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    {
        "name": "Cropland Area (LGRIP30)",
        "slug": "lgrip_cropland_area_km2",
        "label": "Cropland Area (LGRIP30)",
        "group": "other",
        "value_col": "lgrip_cropland_area_km2",
        "periods_metric_col": "lgrip_cropland_area_km2",
        "units": "km2",
        "description": (
            "Cropland extent from LGRIP30 V001 (irrigated plus rainfed classes), 30 m Landsat-derived, nominal 2015. DOI 10.5067/Community/LGRIP/LGRIP30.001."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
        ...
        "supports_baseline_comparison": False,
        "supports_scenario_comparison": False,
        "admin_rebuild_command": "python -m tools.geodata.build_lgrip_admin_masters --overwrite",
        "supported_scenarios": ("snapshot",),
    ...
    {
        "name": "Cropland Share (LGRIP30)",
        "slug": "lgrip_cropland_share_pct",
        "label": "Cropland Share (LGRIP30)",
        "group": "other",
        "value_col": "lgrip_cropland_share_pct",
        "periods_metric_col": "lgrip_cropland_share_pct",
        "units": "percent",
        "description": (
            "Cropland extent as a percent of full unit area in EPSG:6933, from LGRIP30 V001. Attributable replacement candidate for lulc_agri_share_pct (BL-0027)."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    },
    {
        ...
        "slug": "surface_water_permanent_area_km2",
        "label": "Permanent Surface Water Area",
        "group": "other",
        "value_col": "surface_water_permanent_area_km2",
        "periods_metric_col": "surface_water_permanent_area_km2",
        "units": "km2",
        "description": (
            "Inland water present in at least 75 percent of valid observations, from JRC Global Surface Water v1.4 occurrence (1984-2021, 30 m). Marine water is removed by a connectivity mask; see tools/geodata/build_gsw_admin_masters.py."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
        ...
        "supports_baseline_comparison": False,
        "supports_scenario_comparison": False,
        "admin_rebuild_command": "python -m tools.geodata.build_gsw_admin_masters --overwrite",
        "supported_scenarios": ("snapshot",),
        "preferred_period_order": ("Current",),
        "supported_spatial_families": ("admin",),
        "supported_levels": ("district", "block"),
    ...
    {
        "name": "Permanent Surface Water Share",
        "slug": "surface_water_permanent_share_pct",
        "label": "Permanent Surface Water Share",
        "group": "other",
        "value_col": "surface_water_permanent_share_pct",
        "periods_metric_col": "surface_water_permanent_share_pct",
        "units": "percent",
        "description": (
            "Permanent inland water as a percent of full unit area in EPSG:6933, from JRC Global Surface Water v1.4 occurrence. The 75 percent occurrence threshold is a stated choice, not a product definition."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    {
        "name": "Seasonal Surface Water Area",
        "slug": "surface_water_seasonal_area_km2",
        "label": "Seasonal Surface Water Area",
        "group": "other",
        "value_col": "surface_water_seasonal_area_km2",
        "periods_metric_col": "surface_water_seasonal_area_km2",
        "units": "km2",
        "description": (
            "Inland water present in 25 to 74 percent of valid observations, from JRC Global Surface Water v1.4 occurrence. Captures monsoon-filled tanks, floodplain and salt marsh such as the Rann of Kachchh."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
    ...
    {
        "name": "Seasonal Surface Water Share",
        "slug": "surface_water_seasonal_share_pct",
        "label": "Seasonal Surface Water Share",
        "group": "other",
        "value_col": "surface_water_seasonal_share_pct",
        "periods_metric_col": "surface_water_seasonal_share_pct",
        "units": "percent",
        "description": (
            "Seasonal inland water as a percent of full unit area in EPSG:6933, from JRC Global Surface Water v1.4 occurrence."
        ),
        "source_type": "external",
        "supports_yearly_trend": False,
        "selection_mode": "static_snapshot",
