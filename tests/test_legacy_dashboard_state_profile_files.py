"""AST-driven tests for state profile missing-file helper (app/master_freshness)."""
...
def _load_state_profile_files_missing_fn():
    ...
    assert target is not None, "state_profile_files_missing must exist in master_freshness.py"
