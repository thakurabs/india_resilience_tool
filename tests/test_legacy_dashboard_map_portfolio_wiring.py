"""
Regression test: orchestrator_impl must pass `merged=` into the map inline
...
def test_render_unit_add_to_portfolio_call_passes_merged() -> None:
    ...
    assert calls, "Expected a render_unit_add_to_portfolio(...) call in orchestrator_impl.py"
