...
| `tools/geodata/build_jrc_flood_depth_admin_masters.py` | Build Telangana district/block JRC flood-depth masters and stable QA CSVs for `RP10`, `RP50`, `RP100`, and `RP500` | `python -m tools.geodata.build_jrc_flood_depth_admin_masters --help` |
